...
def ImportBOB(args):
    ...
    lib = EagleLibrary(args.libname[0])
...
# determine where to put the output.
    ...
    if args.outlibname is not None:
        f = args.outlibname[0]
    else:
        f = args.libname[0]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--library", required=True,  type=str, nargs=1, dest='libname', help="library file")
    parser.add_argument("--board", required=True,  type=str, nargs=1, dest='boardname', help="board to import relative to BoardsDirecotry")
    parser.add_argument("--headers", required=True, type=str, nargs='+', dest='headers', help="header part identifier")
    parser.add_argument("--copy", type=str, nargs='+', dest='toCopy', help="Components to be replicated")
    parser.add_argument("--name", required=True, type=str, nargs=1, dest='packagename', help="Name for the new package")
    ...
    parser.add_argument("--outlibrary", type=str, nargs=1, dest='outlibname', help="output library file")
    ...
    parser.add_argument("-sch", required=True,  type=str, nargs=1, dest='schematicFile', help="schematic file")
